							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select class="form-control" id="ddl_parent" style="font-weight: bold;">
										<?php
											$list_category = $VideoTypeData->GetListActive();
				...
				<div class="modal-body">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="tb_name" placeholder="Tên bài giảng" data-error="Hãy nhập tên video" required>
							</div>
						</div>
...
<script src="/js/youtube.js?v=2.0.1"></script>
