				...
				<div class="modal-body">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="tb_name" placeholder="Tên chuyên đề" data-error="Hãy nhập tên thể loại" required>
							</div>
						</div>
						<div class="form-group">
...
<script src="/js/video_category.js"></script>