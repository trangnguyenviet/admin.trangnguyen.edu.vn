function MeoTools(div,min_item,finder,callback){
	var self = this;
	this.div = div;
	this._count=0;
...
MeoTools.prototype.Init = function(callback){
...
MeoTools.prototype.SetEvent = function(callback){
	var self = this;
...
MeoTools.prototype.Count = function(){
	return this._count;
};

MeoTools.prototype.Validate = function(){
	var self = this;
	var result = {};
	var msg = '';
...
MeoTools.prototype.SetData = function(datas,callback){
	var self = this;
...
MeoTools.prototype.GetData = function(){
	var self = this;
	var result = {};
	var list_question_item = self.controls.questions.find('.question-item');
...
MeoTools.prototype.AddItem = function(item_data,callback){
	var self = this;
...
MeoTools.prototype.Destroy = function(callback){

};

MeoTools.prototype.SetLatex = function(latex,callback,val){
	console.log(latex);
	if(callback && typeof callback === "function") callback();
};

MeoTools.prototype.OpenLatex = function(obj,latex_type){
	this.latex_editer = obj;
	this.latex_type = latex_type;
	OpenLatexEditor('tb_abc','','vi-vi',false, val || '','full');
};

MeoTools.prototype.SetLatex = function(latex,url,callback){
