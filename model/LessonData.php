...
class LessonData extends ModelBase{
	protected static $collection_name = 'lessons';
	...
	public function GetList($class_id,$parent_id,$page_size,$page_index){
	...
	public function Search($class_id,$parent_id,$search_key,$page_size,$page_index){
	...
	public function Insert($name,$video_type,$url,$duration,$duration_view,$bitrate,$width,$height,$format_name,$codec_name,$class_id,$parent_id,$parent_name,$name_ko_dau,$active,$sort,$thumb,$description,$content,$create_by,$is_publish_date,$publish_at,$publish_end,$tags){
	...
	public function Update($id,$video_type,$url,$duration,$duration_view,$bitrate,$width,$height,$format_name,$codec_name,$class_id,$name,$parent_id,$parent_name,$name_ko_dau,$active,$sort,$thumb,$description,$content,$is_publish_date,$publish_at,$publish_end,$tags){
		$item = [
			'video_type'=>$video_type,
			'url'=>$url,
			'duration'=>intval($duration),
