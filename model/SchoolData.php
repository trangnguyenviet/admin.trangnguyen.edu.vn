...
class SchoolData extends ModelBase{
	protected static $collection_name = 'schools';
	...
	public function GetList($district_id){
	...
	public function Search($district_id,$name){
		$cursor = self::$collection->find(
		[
			'district_id'=>intval($district_id),
	...
	public function CheckExistName($name,$id,$district_id){
		$where = [
			'name' => $name,
	...
	public function Insert($district_id,$name){
