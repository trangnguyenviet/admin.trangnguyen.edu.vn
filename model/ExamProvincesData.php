...
class ExamProvincesData extends ModelBase{
	protected static $collection_name = 'exam_provinces';
...
//	}
	...
	public function Update($id, $name, $area_id, $area_name, $rewrite, $play, $time, $description, $answers, $content) {
		$item = [
			'name' => $name,
			'area_id' => $area_id,
			'area_name' => $area_name,
